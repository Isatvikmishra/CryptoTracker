          ...
          <section className="pt-20 md:pt-40">
            <div className="container mx-auto px-8 lg:flex">
              <div className="text-center lg:text-left lg:w-1/2">
                ...
                A platform wheer you can monitor and analyze real-time cryptocurrency data seamlessly.
                </p>
              ...
              <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                    Instantly track and view live cryptocurrency prices and market trends.
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                     Access detailed coin statistics, charts, and historical data.
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                    Navigate easily with a clean, responsive design for seamless user experience.
                    </p>
                  </div>
                </div>
              </div>
